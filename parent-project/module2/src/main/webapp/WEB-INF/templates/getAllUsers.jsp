...
<div class="container">
    <div class="col-md-12">
        ...
        <form action="add-user.html">
            <input type="submit" value="Add user" class="btn btn-primary btn-sm" style="width: 20%"/>
        </form>
    </div>
</div>
...
<c:if test="${currentPage != 1}">
    <td><a href="user-list.html?page=${currentPage - 1}">Previous</a></td>
</c:if>
    ...
    <tr>
        <c:forEach begin="1" end="${numberOfPages}" var="i">
            <c:choose>
                ...
                <c:otherwise>
                    <td><a href="user-list.html?page=${i}"><c:out value="${i}"/></a></td>
                </c:otherwise>
            </c:choose>
        </c:forEach>
    </tr>
...
<c:if test="${currentPage lt numberOfPages}">
    <td><a href="user-list.html?page=${currentPage + 1}">Next</a></td>
</c:if>
