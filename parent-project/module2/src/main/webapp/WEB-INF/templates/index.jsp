    ...
    <main class="main">
        ...
        <div class="container" style="margin-top: -80px; margin-bottom: 30px">
            <div class="h1 indent-b-48 text-center">
                <p style="color: #002836; font-family: 'French Script MT';font-size: 60px; font-weight: normal">Hello index</p>
            ...
            <div class="benefits-secondary_wrapper" style="margin-top: 30px">
                <div class="benefits-secondary_item"
                    ...
                    <img src="https://profiles.sulekha.com/mstore/40410510/albums/default/thumbnailfull/untitled-design.jpg" class="benefits-secondary_image" alt="boll"
                    ...
                    <div class="benefits-secondary_content" style="min-width: 256px; position: relative; z-index: 1;">
                        ...
                        <div class="benefits-secondary_text"
                            ...
                            Most of these car lease deals are available from stock and are therefore eligible for quick delivery, usually 2-4 weeks.
                        </div>
